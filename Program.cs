...
namespace SPOnlineListDownloader
{
    class Program
    {
        ...
        static string ListName { get; set; }

        private static readonly ILog log = LogManager.GetLogger(typeof(Program));

        static int SomeMain(string[] args)
        {
            SPAttachmentDownloader downloader = new SPAttachmentDownloader();
            downloader.DownloadAttachments();

            SiteUrl = "https://tridentcrm1.sharepoint.com";
            UserName = "vj@tridentcrm1.onmicrosoft.com";

            args = new string[] { "https://tridentcrm1.sharepoint.com", "vj@tridentcrm1.onmicrosoft.com",
                                  "Arch*05012013", @"C:\Users\vinn\Documents\sharepointdocs", "Custom List" };
            ...
            try
            {
                ...
                // Starting with context, the constructor requires a URL to the 
        ...
        {
            string localFilePath = Path.Combine(LocalRootFolder, ListName);//Replace('/', Path.DirectorySeparatorChar).TrimStart('\\')
